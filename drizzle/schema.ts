...
export const products = mysqlTable("products", {
  ...
  imageUrls: json("imageUrls"), // Array of image URLs from S3
...
export const contacts = mysqlTable("contacts", {
  ...
  type: mysqlEnum("type", ["contact", "vendor_request"]).default("contact").notNull(),
...
export const storeConfig = mysqlTable("storeConfig", {
  ...
  storeName: varchar("storeName", { length: 255 }).default("MedicalStore").notNull(),
